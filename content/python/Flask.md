        ...
        <div class="card" style="width: 18rem;">
            <div class="card-body">
                ...
                <button type="button" class="btn btn-primary"
                    hx-post="/clicked_text" 
                    hx-target="#parent-div"
                    hx-swap="innerHTML" >Primary</button>
                <div id="parent-div">
                    Text1
                </div>
            </div>
...
@app.route('/clicked_text', methods = ['POST'])
def clicked_text():
...
```html
    <div class="card" style="width: 18rem;">
        <div class="card-body">
            ...
            <button type="button" class="btn btn-primary"
                hx-post="/clicked_button"
                hx-swap="outerHTML"
                hx-vals='{ "userNumber": "1" }'>
                plus 1
            </button>
        </div>
    </div>
...
def clicked_button():
    if request.method == 'POST':
        userNumber = int(request.form['userNumber'])
        return render_template('button.html', userNumber=userNumber+1)
```
